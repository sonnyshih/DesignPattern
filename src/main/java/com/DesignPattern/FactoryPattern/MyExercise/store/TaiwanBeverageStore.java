...
import com.DesignPattern.FactoryPattern.MyExercise.factory.TaiwanIngredientFactory;

public class TaiwanBeverageStore extends BerverageStore {

    BeverageIngredientFactory ingredientFactory;

    public TaiwanBeverageStore (){
        ingredientFactory = new TaiwanIngredientFactory();
    }
